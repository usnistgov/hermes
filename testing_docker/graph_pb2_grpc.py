...
class GraphServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendAndModifyGraph = channel.unary_unary(
                '/graph.GraphService/SendAndModifyGraph',
                request_serializer=graph__pb2.Graph.SerializeToString,
                response_deserializer=graph__pb2.Graph.FromString,
...
def add_GraphServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendAndModifyGraph': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=graph__pb2.Graph.SerializeToString,
            ),
    }
